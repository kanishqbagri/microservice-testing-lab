...
CHART_PATH="./helm-charts/user-service"
...
echo "kubectl logs -l app=user-service -c user-service -n $NAMESPACE"
echo "kubectl logs -l app=user-service -c postgres-sidecar -n $NAMESPACE"
echo ""
