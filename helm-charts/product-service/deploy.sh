...
CHART_PATH="./helm-charts/product-service"
...
echo "kubectl port-forward svc/product-service 8081:8081 -n $NAMESPACE"
echo ""
echo -e "${BLUE}🔍 To check logs:${NC}"
echo "kubectl logs -l app=product-service -c product-service -n $NAMESPACE"
echo "kubectl logs -l app=product-service -c postgres-sidecar -n $NAMESPACE"
echo ""
